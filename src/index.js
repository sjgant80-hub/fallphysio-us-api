// fallphysio-us-api · Express HTTP wrapper around fallphysio-us-sdk · MIT · AI-Native Solutions
import express from 'express';

const app = express();
app.use(express.json({ limit: '10mb' }));

app.get('/health', (_req, res) => res.json({ ok: true, tool: 'fallphysio-us', version: '1.0.0' }));
...
app.listen(PORT, () => console.log('fallphysio-us-api listening on :' + PORT));
